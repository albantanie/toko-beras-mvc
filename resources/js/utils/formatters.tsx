            ...
            {actions.map((action, index) => (
                action.href ? (
                    <Link
                        key={index}
                        href={action.href}
                        className={`text-sm font-medium ${variants[action.variant || 'primary']}`}
                    >
                    ...
                    <button
                        ...
                        className={`text-sm font-medium text-left ${variants[action.variant || 'primary']}`}
                    >
                        <div className="flex items-center space-x-1">
                            {action.icon && <span className="w-4 h-4">{action.icon}</span>}
                            <span>{action.label}</span>
...
export const Icons = {
    ...
    trophy: (props: React.SVGProps<SVGSVGElement>) => (
        <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 0 1 3 3h-15a3 3 0 0 1 3-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 0 1-.982-3.172M9.497 14.25a7.454 7.454 0 0 0 .981-3.172M5.25 4.236c-.982.143-1.954.317-2.916.52A6.003 6.003 0 0 0 7.73 9.728M5.25 4.236V4.5c0 2.108.966 3.99 2.48 5.228M5.25 4.236V2.721C7.456 2.41 9.71 2.25 12 2.25c2.291 0 4.545.16 6.75.47v1.516M7.73 9.728a6.726 6.726 0 0 0 2.748 1.35m8.272-6.842V4.5c0 2.108-.966 3.99-2.48 5.228m2.48-5.228a7.454 7.454 0 0 1-.981 3.172M9.497 14.25v3.375c0 .621.504 1.125 1.125 1.125h.872m-5.007 0H9.497m5.007 0a7.454 7.454 0 0 1-.982 3.172M9.497 14.25a7.454 7.454 0 0 0 .981 3.172M5.25 4.236v1.516c2.291-.31 4.545-.47 6.75-.47s4.455.16 6.75.47v1.516M7.73 9.728a6.726 6.726 0 0 1 2.748-1.35m8.272-6.842a6.726 6.726 0 0 0-2.748-1.35" />
        </svg>
    ),
