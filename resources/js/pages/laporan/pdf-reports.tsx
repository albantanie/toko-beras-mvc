...
import { Download, FileText, Calendar, Filter, Plus, User } from 'lucide-react';
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                            <div>
                                ...
                                <Select value={localFilters.type || 'all'} onValueChange={(value) => handleFilterChange('type', value === 'all' ? '' : value)}>
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="penjualan">Sales</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <Select value={localFilters.generator || 'all'} onValueChange={(value) => handleFilterChange('generator', value === 'all' ? '' : value)}>
                                    <SelectTrigger>
                                            ...
                                            <div className="text-sm text-gray-600 space-y-1">
                                                ...
                                                {report.generator && (
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span>Generated by: <span className="font-medium">{report.generator.name}</span></span>
                                                    </div>
                                                )}
                                                ...
                                                {report.approved_at && (
                                                    <div>
                                                        ...
                                                        {report.approver && <span> by {report.approver.name}</span>}
                                                    </div>
                                                )}
                                            </div>
                                        </div>
