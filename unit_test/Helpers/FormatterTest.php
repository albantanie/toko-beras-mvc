...
class FormatterTest extends TestCase
{
    ...
    public function can_format_small_compact_currency()
    {
        ...
        $this->assertEquals('Rp 2rb', $formatted);
    }
    ...
    public function can_format_payment_method()
    {
        ...
        $formatted = str_replace('_', ' ', ucfirst($method));
    ...
    public function can_format_category_name()
    {
        ...
        $formatted = str_replace('_', ' ', ucfirst($category));
    ...
    public function can_format_permission_name()
    {
        ...
        $formatted = str_replace('_', ' ', ucfirst($permission));
    ...
    {
        $filter = 'price_range';
        $formatted = str_replace('_', ' ', ucfirst($filter));
    ...
    public function can_format_file_size()
    {
        ...
        $this->assertEquals('1.0 KB', $formatted);
    }
    ...
    public function can_format_large_file_size()
    {
        ...
        $this->assertEquals('1.0 MB', $formatted);
    }
    ...
    public function can_format_compact_number_for_thousands()
    {
        ...
        $this->assertEquals('2rb', $formatted);
    }
    ...
    private function formatCompactCurrency($num)
    {
        ...
        if ($absNum >= 1000000000) {
            ...
            return 'Rp ' . number_format($num / 1000, 0) . 'rb';
        } else {
    ...
    private function formatCompactNumber($num)
    {
        ...
        if ($absNum >= 1000000) {
            ...
            return number_format($num / 1000, 0) . 'rb';
        } else {
